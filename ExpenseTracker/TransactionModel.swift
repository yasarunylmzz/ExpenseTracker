...
extension Category{
    static let autoAndTransport = Category(id: 1, name: "Auto & Transports", icon: .car_alt)
    ...
    static let transfer = Category(id: 9, name: "Transger", icon: .exchange_alt)
    ...
    static let restaurants = Category(id: 502, name: "Restaurant", icon: .utensils, mainCategoryId: 5)
